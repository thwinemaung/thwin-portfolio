          ...
          <div className='w-screen flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-20 md:p-44 h-screen'>
            ...
            <div className='space-y-10 px-0 md:px-10 max-w-6xl'>
              ...
              <p className='text-lg text-center md:text-left'>
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nemo quis incidunt accusantium deserunt laboriosam delectus ducimus magnam maxime voluptas numquam itaque, perferendis sequi possimus asperiores reprehenderit. Quaerat natus ut placeat!
              </p>
            </div>
          </div>
        ))}
